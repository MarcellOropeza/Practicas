    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            */
            ...
            Vector my_vector = new Vector(2,3,5,7);
            Vector my_vector_2 = new Vector(8,2,1,4);

            double my_vector_3 = my_vector * my_vector_2;


            Console.WriteLine($"El valor de la multiplicación es de: {my_vector_3}");
